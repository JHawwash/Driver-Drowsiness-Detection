...
########## Initializing the Model, Buzzer, Camera, and Text Font ##########


# Loading Our CNN Model
drowsiness_detector_model = load_model('/home/mjr/Desktop/GP2/Our_Model_V2/model.h5')
    ...
    if faces:
         for face in faces[0]: # For the first face
            ...
            if face: # If the face is detected
                ...
                # If the prediction >= 0.5 (Awake), reset the drowsy_score to 0
                elif prediction >= 0.5:
                    drowsy_score = 0
